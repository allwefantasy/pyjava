...
public final class ArrowColumnVectorV2 extends ColumnVector {

    private final ArrowVectorAccessor accessor;
    private ArrowColumnVectorV2[] childColumns;
    ...
    @Override
    public ArrowColumnVectorV2 getChild(int ordinal) {
        return childColumns[ordinal];
    }

    public ArrowColumnVectorV2(ValueVector vector) {
        ...
        if (vector instanceof BitVector) {
            ...
            childColumns = new ArrowColumnVectorV2[structVector.size()];
            for (int i = 0; i < childColumns.length; ++i) {
                childColumns[i] = new ArrowColumnVectorV2(structVector.getVectorById(i));
            }
        } else {
            throw new UnsupportedOperationException();
        }
    ...
    private static class ArrayAccessor extends ArrowVectorAccessor {
        ...
        private final ArrowColumnVectorV2 arrayData;

        ArrayAccessor(ListVector vector) {
            super(vector);
            this.accessor = vector;
            this.arrayData = new ArrowColumnVectorV2(vector.getDataVector());
        }
