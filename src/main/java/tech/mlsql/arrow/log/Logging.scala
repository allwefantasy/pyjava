package tech.mlsql.arrow.log

import org.slf4j.{Logger, LoggerFactory}

/**
 * SLF4J logger for classes that cross a task boundary. The logger is transient so a
 * serialized task does not try to ship an SLF4J implementation with it.
 */
trait Logging {
